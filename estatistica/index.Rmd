...
2. $\epsilon \sim (\mathbf{0},\mathbf{\Psi})$, em que $\mathbf{\Psi}=diag(\psi_1,\dots,\psi_p)$;
	 
3. $\mathbf{f}$ e $\mathbf{\epsilon}$ são independentes;
